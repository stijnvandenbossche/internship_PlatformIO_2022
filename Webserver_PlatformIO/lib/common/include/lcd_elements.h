...
#define IP_ADDRESS_ISDISPLAYED 1 //0
...
#define BG_OPTIONS_LOCATION_Y Y_CONV(50)
...
#endif
#ifdef BOARD_ESP32
#define CHAT_BOX_FONT Font8
#endif
#define CHAT_BOX_ISDISPLAYED 0

#define COMPILATION_TABLE_LOCATION_X X_CONV(160)
#define COMPILATION_TABLE_LOCATION_Y Y_CONV(50)
#define COMPILATION_TABLE_HEIGHT (SCREEN_YSIZE - COMPILATION_TABLE_LOCATION_Y)
...
#define COMPILATION_TABLE_AMOUNT_CELLS_HORIZONTAL 3
#define COMPILATION_TABLE_AMOUNT_CELLS_HORIZONTAL 6

#define COMPILATION_TABLE_TITLE_HEIGHT X_CONV(20)
#define COMPILATION_TABLE_TITLE_WIDTH COMPILATION_TABLE_WIDTH

#define COMPILATION_TABLE_CELL_HEIGHT COMPILATION_TABLE_WIDTH / COMPILATION_TABLE_AMOUNT_CELLS_HORIZONTAL
#define COMPILATION_TABLE_CELL_WIDTH COMPILATION_TABLE_WIDTH / COMPILATION_TABLE_AMOUNT_CELLS_HORIZONTAL
